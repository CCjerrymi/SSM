...
<body>
		...
		<ul class="nav nav-pills nav-stacked" id="question">
	
		</ul>
	</div>
	<div name="showData" id="showDate" style="padding:100px;border-left:1px solid black">
...
<!--外部js  -->
<script type="text/javascript" src="module/js/system/user.js"></script>
</html>
